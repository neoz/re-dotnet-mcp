...
public sealed class SearchTools
{
    ...
    public PageDto<UserStringEntry> ListUserStrings(
        ...
        => PageDto<UserStringEntry>.From(_strings.ListUserStrings(_registry.Get(id), filter_regex, min_length, offset, limit));
    ...
    public PageDto<LdstrEntry> ListLdstrStrings(
        ...
        => PageDto<LdstrEntry>.From(_strings.ListLdstrStrings(_registry.Get(id), filter_regex, offset, limit));
    ...
    public PageDto<CodeStringMatch> FindCodeByString(
        ...
        int? offset = null, int? limit = null)
        => PageDto<CodeStringMatch>.From(_strings.FindCodeByString(_registry.Get(id), regex, offset, limit));
    ...
    public PageDto<IlSearchHit> SearchIl(
        ...
        int? offset = null, int? limit = null)
        => PageDto<IlSearchHit>.From(_il.SearchIl(_registry.Get(id), pattern, offset, limit));
    ...
    public PageDto<BytesHit> SearchBytes(
        ...
        int? offset = null, int? limit = null)
        => PageDto<BytesHit>.From(_il.SearchBytes(_registry.Get(id), hex_pattern, section, offset, limit));
    ...
    public PageDto<DangerousApiHit> FindDangerousApis(
        ...
        int? offset = null, int? limit = null)
        => PageDto<DangerousApiHit>.From(_danger.Find(_registry.Get(id), preset, offset, limit));
}
